...
```css title="styles/syntax-highlighting.css"
figure[data-rehype-pretty-code-figure] {
  @apply mt-4 w-full rounded-[--radius-base] border border-[--border] bg-[--iris-2];
}
...
figcaption[data-rehype-pretty-code-title] {
  @apply text-small border-b border-border px-4 py-1 text-[--iris-9];
}
