...
export const CommandMenu = () => {
  ...
  return (
    <Command.Dialog
      ...
      className="border-iris-4 bg-iris-2 pointer-events-auto relative min-w-72 rounded-xl border leading-snug"
    >
      <div className="border-iris-4 border-b px-4 py-3">
        <Command.Input
          placeholder="Type a command or search..."
          className="placeholder:text-iris-8 bg-transparent outline-none"
        />
      </div>
      <Command.List className="p-2">
        <Command.Empty className="text-iris-10 p-2">
          No results found.
        </Command.Empty>
        <CommandItem
          onSelect={() => {
