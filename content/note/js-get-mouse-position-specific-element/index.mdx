...
<Image
  className="bg-white-a11 rounded-none"
  src="https://developer.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect/element-box-diagram.png"
  alt="DOMRect object that is the smallest rectangle containing the entire element."
  caption="Element: getBoundingClientRect() method - Web APIs | MDN"
/>
