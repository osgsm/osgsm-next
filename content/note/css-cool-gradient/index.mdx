...
<Preview codeblock>
  <div
    style={{
      ...
      borderRadius: '0.5rem',
      background:
        'radial-gradient(circle at 50% 180%, rgb(253 39 143 / 30%) 30%, rgb(253 76 253 / 15%) 50%, rgb(0 119 255 / 23%) 60%, transparent)',
    }}
  />
</Preview>
...
<Preview codeblock>
  <div
    style={{
      ...
      borderRadius: '0.5rem',
      background:
        'radial-gradient(ellipse at 100% 100%, rgb(7 0 31 / 12%), rgb(68 34 255 / 6%), transparent), linear-gradient(to bottom right, #0f1b1b, #141726, #37172f, #082c36)',
    }}
  />
</Preview>
