  ...
  return (
    <>
      <button
        ...
        className={cn(
          'group ml-auto flex rounded-full border border-iris-5 bg-iris-4 p-0.5 backdrop-blur-sm transition-colors'
        )}
        aria-label="Search"
      >
        <span
        ...
        >
          ...
          <span
            className={cn(
              'hidden text-sm leading-none tracking-wide text-iris-11/75 transition-colors',
